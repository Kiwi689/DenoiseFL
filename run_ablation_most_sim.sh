...
LOG_DIR="${PROJECT_DIR}/ablation_logs_most_sim"
mkdir -p "${LOG_DIR}"
...
TEACHER_SELECT_STRATEGY="most_sim"
...
launch_job() {
    ...
    local job_name="feddenoise_v3_${dataset}_alpha${alpha}_most_sim"
...
wait
echo "[Done] most_sim ablation finished."